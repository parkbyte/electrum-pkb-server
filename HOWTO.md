...
The most up-to date version of this document is available at:
    ...
    https://github.com/justinvforvendetta/electrum-pkb-server/blob/master/HOWTO.md
...
We will download the latest git snapshot for Electrum to configure and install it:
    ...
    $ cd ~
    $ git clone https://github.com/justinvforvendetta/electrum-pkb-server.git
    $ cd electrum-pkb-server
    $ sudo configure
